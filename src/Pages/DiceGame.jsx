...
class DiceGame extends React.Component {
    ...
    winGame(winner) {
        ...
        this.setState({
                messageText: winner + " is the Winner",
                isGameOver: true,
                dicesResult: [0, 0],
            }
        )
    ...
    render() {
        const {
            player1, player2, dicesResult
            , gameOver, message, isGameOver
            , isGameStart, targetScore, isOpeningPage
        } = this.state
                    ...
                    <div
                        ...
                        <div className={this.state.player1.isTurn ? " " : " flip"}>
                            <div className={this.state.themeColor}>
                                ...
                                <div
                                    className={gameOver ? "DiceGame-winning-message" : '.DiceGame-winning-message  .DiceGame-winning-message-show'}>
                                    <h1>{message}</h1></div>
                            </div>
                        </div>
                    </div>
